...
2. **Hygiène Git & Sécurité :**
   * Ne JAMAIS commiter de fichiers sensibles (`.env`, `credentials.json`, `token.json`, `.venv`).
   * Des commits atomiques et explicites au format Conventional Commits (`feat:`, `fix:`, `test:`, `docs:`, `refactor:`).
